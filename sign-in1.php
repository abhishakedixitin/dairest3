...
115	alert("Login is compulsary. If NEW user REGISTER first. If EXISTING user LOGIN first. Unautorised user will not be able to Shop.");
116	</script>
			...
			<div class="header-top-area ptb-10 hidden-xs header-top-area-4">
				<div class="container">
                    ...
                    <li class="click_menu"><a href="#">My Account <i class="fa fa-angle-down"></i></a>
									...
									<li><a href="sign-up1.php">Create an Account</a></li>
								</ul>
							</div>
						</div>
                  ...
                  <li><a href="#">Navigation</a>
                    <ul>
                      ...
                      <li><a href="sign-in.php">login</a></li>
                                            <li><a href="sign-up1.php">Register</a></li>
   ...
   <div class="x0" style="width:1300px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
        ...
        <h4 style="font-size: 15%vw">Username:</h4><br>
          
          <p> <a href= "forgotUsername.php" style="color:blue;margin-top:5%; font-size: 5%vw">Forgot Username?</a></p>
       ...
       <br><br> <h4 style="font-size: 15%vw">Password:</h4>
          ...
          <p> <a href= "forgotPassword.php" style="color:blue;margin-top:5%; font-size: 5%vw">Forgot Password?</a></p>
        ...
        <center><h5 style="color:blue; padding-top:2%;font-size: 5%vw">New Member?
		      <button class ="button" type="submit" onclick= "window.location.href='sign-up1.php'">Sign Up Here!</button>
            </h5></center>center>
             
		  </div>
      <div class="x1">
        <figure>
          <img src="img/logo/mumu.png" style="width:60%vw; height:60%vw;" alt="hello">
        </figure>
      </div>
    </div>
    <!-- sign-in-area-start -->
...
if (screen.width <= 699) {
document.location = "mobile-sign-in.php";
}
