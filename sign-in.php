...
<html class="no-js" lang="en">
    ...
    <div class="x0" style="width:1300px; margin-top:0.000001px; padding:0.00001px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
        ...
        <h1 style="font-size: 50%; text-align:center">Sign In</h1><br>
        <h4 style="font-size: 15%">Username:</h4>
     ...
     <h4 style="font-size: 15%">Password:</h4>
       ...
       <center><h5 style="color:blue; padding-top:2%;font-size: 5%">New Member?
      ...
      <div class="x1" style="float:right">
        <figure>
          <img src="img/logo/mumu.png" style="width:60%; height:60%;" alt="">
        </figure>
      </div>
    </div>
    <!-- sign-in-area-start -->
...
if (screen.width <= 699) {
location.assign("mobile-sign-in.php")
}
