...
if(isset($_POST['submit_email']) && $_POST['email'])
{
  ...
  if(mysql_num_rows($select)==1)
  {
    ...
    $link="<a href='new-password.php?key=".$email."&reset=".$pass."'>Click To Reset password</a>";
    ...
    $mail->SMTPAuth = true;                  
    // GMAIL username
    $mail->Username = "prashantsh0404@gmail.com";
    // GMAIL password
    $mail->Password = "1000*Goforit";
    $mail->SMTPSecure = "ssl";  
    ...
    if($mail->Send())
    {
     echo '<center> <h3 style="font-size:140%">Kindly check email for link to set up new password.</h3></center>'; 
    }
    else
    {
         echo '<p>"Mail Error - >"</p>.$mail->ErrorInfo';
    }
  }	
        ?>
          <br><br><br>
