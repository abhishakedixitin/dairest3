	...
	if (isset($_POST['user_name']) && isset($_POST['user_password']))
	{
        ...
        echo '<a>
		  <img src= "img/error/2.png" alt= "" class="sad">
				...
				echo '<center><h1><a href="sign-up1.php">Click here to Register again</a></h1></center>'; 
				?>
				...
				else
				{
                     ...
                     echo '<a>
		  <img src= "img/logo/jump.png" alt= "" class="happy">
		</a><br>;
						echo '<center><h4>Welcome to the candy parade! </h4></center><br><br><br>'; 
                        echo '<center><h4>User successfully created.</h4></center><br><br><br>';
						echo '<center><h2><a href="sign-in1.php" style="text-decoration:underline">Click here to Sign In</a></h2></center>'; 
				}					
				}
				?>	
	</div>
