...
<html class="no-js" lang="en">
    ...
    <div class="x0" style="width:1300px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
        ...
        <h3 style="font-size: 50%vw; text-align:center">Get link for new Password </h3><br><br>
              
      <h4 style="font-size: 15%vw">Registered Email Id:</h4>
          <input type="email" name="email" style="border-color:rgb(110,65,30);border-width:thin" size="30" required><br>
                   <p> <a href= "forgotEmail.php" style="color:blue;margin-top:5%; font-size: 0.9vw;text-decoration: underline">Forgot Email Id?</a></p>
          
          <center><input  type="submit" name="submit_email" style="margin-top:6%">Submit</center>
               </form>
        </div>
