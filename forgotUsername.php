...
<html class="no-js" lang="en">
    ...
    <div class="x0" style="width:1300px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
          ...
          <form action="emailUsername.php" method="post" style="width:410px;height:250px; padding:13px">
              
        <h3 style="font-size: 50%vw; text-align:center">Get your registered Username </h3><br><br>
