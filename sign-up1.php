...
<html class="no-js" lang="en">
    ...
    <body>
		<header>
			<div class="header-top-area ptb-10 hidden-xs header-top-area-4" style="background-color:rgb(110,65,10)">
				<div class="container">
					<div class="row">
...
<br><br>
      ...
      <div class="x1">
        <figure>
          <img src="img/logo/mumu3.png" style="width:60%vw; height:60%vw;" alt="hello">
        </figure>
      </div>
    </div>
    <!-- sign-in-area-end -->
